...
export const inputVariant = cva(
    'flex h-10 w-full rounded-md border border-[#0B3859] bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none disabled:cursor-default',
    {
      variants: {
        size: {
          base: 'h-10 text-sm',

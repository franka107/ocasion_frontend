    ...
    <header class="flex bg-white shadow-md py-4 h-[120px]">
      <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="flex space-x-2">
          <Button variant="default" class="text-[16px] font-inter font-[600]">INGRESAR</Button>
          <Button class="text-[16px] font-[600] bg-white text-primary border border-primary hover:bg-accent">REGÍSTRATE
            YA!</Button>
        </div>
      </div>
    </header>

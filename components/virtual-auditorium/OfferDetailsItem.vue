...
<template>
    <section class="flex justify-center">
        ...
        <div class="grid mx-auto">
            <div class="w-full max-w-[350px] max-h-[394px] flex flex-col shadow-[0px_0px_4px_0px_#0000001A] bg-white rounded-[8px] overflow-hidden">
                        <!-- Contador en cajitas -->
                    ...
                    <div class="px-[12px] pt-[20px] pb-[16px]">
                        ...
                        <h2 class="text-[#152A3C] text-[16px] font-[600] leading-[24px] pb-[16px] uppercase">
                            {{ offer.title }}
                        </h2>
                        <div class="flex flex-col">
                            <div class="flex gap-x-[4px] leading-[16px]">
                                <p class="text-[#68686C] text-[12px] font-[600] text-center mb-[5.5px] flex items-center ">
                                    Valor actual
                                </p>
                                <button type="button" class="mb-[4px]"><CustomIcons name="Info" class="mt-[1.5px] w-4 h-4 text-primary" /></button> 
                            </div>
                            <p class="font-[700] text-[14px] text-[#20445E] mb-4">USD ${{ offer.bid?.amount || 0 }}</p>
                        </div>
                    </div>
                        <div class="mb-4">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex flex-col items-center">
                                <div class="flex flex-wrap justify-center gap-y-[8px] gap-x-[16px] px-[22px]">
                                <Button

            ...
            <section class="flex-grow">
                <div class="grid grid-cols-1 gap-4 mb-[24px]">
                    ...
                    <FormField v-slot="{ componentField }" name="businessName">
                        <FormItem>
                            <FormControl>
                                <CustomInput type="text" label="Razón Social" v-bind="componentField" disabled/>
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    </FormField>
                    ...
                    <FormField v-slot="{ componentField }" name="ruc">
                        <FormItem>
                            <FormControl>
                                <CustomInput type="text" label="RUC" v-bind="componentField" disabled/>
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    </FormField>
                    ...
                    <FormField v-slot="{ componentField }" name="legalRepresentative">
                        <FormItem>
                            <FormControl>
                                <CustomInput type="text" label="Representante Legal" v-bind="componentField" disabled/>
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    </FormField>
                    <div class="flex gap-2">
                        ...
                        <FormField v-slot="{ componentField }" name="documentIdentifier">
                            <FormItem class="w-full">
                                <FormControl>
                                    <CustomInput type="text" label="Número de Documento" v-bind="componentField" disabled/>
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        </FormField>
                    ...
                    <FormField v-slot="{ componentField }" name="taxAddress">
                        <FormItem>
                            <FormControl>
                                <CustomInput type="text" label="Domicilio Fiscal" v-bind="componentField" disabled/>
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    </FormField>
                    ...
                    <FormField v-slot="{ componentField }" name="email">
                        <FormItem>
                            <FormControl>
                                <CustomInput type="text" label="Email" v-bind="componentField" disabled/>
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    </FormField>

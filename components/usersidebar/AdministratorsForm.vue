      ...
      <FormField v-slot="{ componentField }" name="userRole">
          <FormItem>
            <FormControl>
              <Select v-bind="componentField">
                <SelectTrigger>
                  <SelectValue placeholder="Rol Usuario" />
                </SelectTrigger>
                <SelectContent>
                    <SelectGroup>
                      <SelectItem value="rol">SUPER ADMINISTRADOR</SelectItem>
                      <SelectItem value="rol">ADMINISTRADOR ORGANIZACIÓN</SelectItem>
                      <SelectItem value="rol">ADMINISTRADOR PLATAFORMA</SelectItem>
                    </SelectGroup>
                  </SelectContent>
              </Select>
            </FormControl>

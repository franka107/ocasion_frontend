...
const formSchema = toTypedSchema(
    z.object({
        ...
        transferDate: z.string().nonempty('La fecha de transderencia es requerida').optional(),
        amount: z
            .number()
...
<template>
    <AlertDialog :open="modelValue" class="z-[30]" @update:open="(event) => emit('update:modelValue', event)">
        <AlertDialogContent class="z-[98] h-auto  max-w-[670px] px-0">
            <form class="flex flex-col gap-6 flex-grow max-h-[calc(100vh-4rem)] overflow-y-auto scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-primary/50" @submit="onSubmit">
                ...
                <AlertDialogHeader class="border-b border-primary">
                    <AlertDialogTitle
                        class="text-xl tracking-[-0.5px] text-primary text-start font-[600] px-6 pb-[18px]">Retirar
                        saldo</AlertDialogTitle>
                </AlertDialogHeader>
                ...
                <div class="grid grid-cols-2 gap-4 px-6">
                    ...
                    <FormField v-slot="{ componentField }" name="transferDate">
                        <FormItem>
                            <FormControl>
                                <CustomInput staticLabel type="date" label="Fecha de transferencia" v-bind="componentField" />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    </FormField>
                    ...
                    <FormField v-slot="{ componentField }" name="amount">
                        <FormItem>
                            <FormControl>
                                <CustomInput v-bind="componentField" type="number" placeholder="0.00" staticLabel
                                    label="Ingresa monto" />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    ...
                    <FormField v-slot="{ componentField }" name="currency">
                        <FormItem>
                            <FormControl>
                                <CustomSelect v-bind="componentField" :items="[{ id: 'USD', name: 'USD' }]" staticLabel
                                    placeholder="Moneda" />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                ...
                <div class="px-6">
                    ...
                    <FormField v-slot="{ componentField }" name="attachedFiles" class="max-h-[156px]">
                        <FormItem>
                            <FormControl>
                                <InputFile v-model="form.values.attachedFiles" title="Archivos adjuntos"
                ...
                <div class="px-6">
                    ...
                    <FormField v-slot="{ componentField }" name="termsAndConditions">
                        <FormItem class="flex items-center gap-2">
                            <FormControl>
                                <Checkbox :checked="componentField.modelValue" v-bind="componentField"
                                    @update:checked="componentField.onChange" />
                                <label class="font-[400] text-[14px] m-[0px] space-y-0 text-[#152A3C]">Aceptar <span
                                        class="font-[600] text-[#F97316]">terminos y condiciones</span>
                                </label>
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    ...
                    <div class="rounded-[8px] bg-[#F3F8FC] p-4 mt-[18px]">
                        ...
                        <ul class="font-[400] text-[12px] text-[#45454F] mt-[12px] space-y-2">
                            <li>
                                • La cuenta de destino de DeOcasión es <b>en Dólares.</b> Cualquier transacción en otro
                                tipo de moneda estará sujeto al tipo de cambio del banco de su cuenta.
                            </li>
                            <li>
                                • El número de cuenta de DeOcasión es del banco: BCP: 123456789012, CCI:
                                0110123456789012(números de cuenta pendiente de definir)
                            </li>
                            <li>
                                • El tiempo de revisión de la solicitud es de 3 días útiles.
                            </li>
                            <li>
                                • La comisión de transferencia estará sujeto a las condiciones del banco y serán
                ...
                <AlertDialogFooter class="px-6">
                    ...
                    <Button type="submit" size="xl" class="text-[16px] font-[600] mt-[16px]"

                    ...
                    <form @submit.prevent="handleSubmit">
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 text-[#0F172A] text-[14px] pt-[24px]">
                            <div class="flex gap-2">
                                <div class="w-1/2">
                                    <label for="documentType" class="block text-sm font-medium mb-[6px]">Tipo de documento <span class="text-[#F6313C]">*</span></label>
                            ...
                            <div>
                                <label for="lastNameFather"
                                    class="block text-sm font-medium mb-[6px]">Apellido
                            ...
                            <div class="flex gap-2">
                                ...
                                <div class="w-1/2">
                                    <label for="maritalStatus"
                                        class="block text-sm font-medium mb-[6px]">Estado civil
                                        <span class="text-[#F6313C]">*</span></label>
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 text-[#0F172A] text-[14px] pt-[24px]">
                            ...
                            <div>
                                ...
                                <Input v-model="formData.newPassword" id="newPassword" type="text"
                                    placeholder="Nueva contraseña" class="mt-1 block w-full" />
                            </div>
                            <div>
                                <div class="flex">
                        ...
                        <NuxtLink to="https://web.dev.deocasion.pe/auth/register" rel="noopener noreferrer"><p class="mt-[24px] mb-[32px] text-[#052339] text-[14px] font-[600]">He olvidado mi contraseñe actual</p></NuxtLink> 

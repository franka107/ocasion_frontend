                ...
                <div
                    ...
                    <div class="flex flex-wrap justify-between items-center gap-y-[20px]">
                        ...
                        <div class="flex flex-col md:flex-row gap-x-4 w-auto ">
                            <NuxtLink type="button" :href="offerDetail.event?.termsAndConditionsFiles[0]?.path" target="_blank"
                            ...
                            <div class="flex flex-col justify-center w-full md:w-[63%]">
                                ...
                                <div class="flex w-full items-center" style="max-width: 692px;">
                                    <div class="flex justify-center md:w-full w-[62vw] mt-[16px] mx-auto">
                                        <Carousel class="relative w-full max-w-xs h-auto md:h-[52%]"
                                            :opts="{ align: 'start', loop: isLooping }">
                                            <CarouselContent>
                                                <CarouselItem v-for="(media, index) in attachedMedia" :key="index"
                                                    :class="{
                                                        'basis-1/4': attachedMedia.length > 3,
                                                        'basis-1/3': attachedMedia.length <= 3 && attachedMedia.length > 1,
                                                        ...
                                                        <Card class="rounded-[0px]">
                                                            <CardContent class="p-0">
                                                                <template v-if="media.isVideo">
                                                                    <video :src="media.src"
                                                                        class="w-full h-full max-w-[65px] max-h-[50px] rounded-0"></video>
                                                                </template>
                                                                <template v-else>
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <div v-if="activeTab === 'description'">
                                        <p class="my-[16px] text-[14px] text-[#000000] text-justify">{{
                                    ...
                                    <div v-if="activeTab === 'annex'">
                                        <div
                                            ...
                                            <div v-for="(file, index) in annexesFiles" :key="file.id"

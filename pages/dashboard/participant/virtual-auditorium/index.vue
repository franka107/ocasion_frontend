    ...
    <section class="rounded-[12px] bg-white w-full max-w-[1324px] px-[24px] py-[16px]">
      <div class="tabs-container">
        ...
        <div class="flex justify-between">
          <ScrollArea class="flex border-b border-gray-300 text-[#AFAFB1] gap-x-2 md:gap-x-4 whitespace-nowrap text-[12px] md:text-[16px]">
            <div class="flex gap-x-[16px]">
              <button v-for="(tab, index) in tabs" :key="index"
                :class="['pt-[8px] pb-[16px] font-[500]', { 'text-[#20445E] border-b-2 border-[#20445E]': activeTab === index }]"

...
const { findNotificationsPaginated, page } = useNotificationAPI()
...
//       notifications.value?.data?.map((n) => n.id) || []
//   } else {
//     selectedNotifications.value = []
//   }
// }
...
//
//   selectAll.value =
//     selectedNotifications.value.length === notifications.value?.data?.length
// }
//
// const handleMarkAsRead = () => {
...
//       {
//         field: 'createdAt',
//         order: sortType.value === 'reciente' ? 'desc' : 'asc',
//       },
//     ],
//   }
//
